...
function App() {
    ...
    return (
        <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20 m'>
            <img src={logo} />
            ...
            <div className="grid grid-cols-6 gap-6 mt-16">
                {games.map(game => { return <GameBanner key={game.id} bannerUrl={game.bannerUrl} title={game.title} adsCount={game._count.ads} /> })}
            </div>
            <Dialog.Root>
                <CreateAdBanner />
                <Dialog.Portal>
